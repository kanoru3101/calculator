                ...
                <Row>
                    <Col xs="12" sm="12">
                        <Row>
                            ...
                            <Col xs="12" sm="12"  style={paddingStyle}>
                                <button id="7" className="button buttonNormal col-3" value="7" onClick={e => this.props.number("7")}>7</button>
                                <button id="8" className="button buttonNormal col-3" value="8" onClick={e => this.props.number("8")}>8</button>
                                <button id="9" className="button buttonNormal col-3" value="9" onClick={e => this.props.number("9")}>9</button>
                                <button id="subtract" className="button buttonNormal col-3" value="-" onClick={e => this.props.operator("-")}>
                                    <FontAwesomeIcon icon="minus"/>
                                </button>
                            </Col>
                            <Col xs="12" sm="12" style={paddingStyle}>
                                <button id="4" className="button buttonNormal col-3" value="4" onClick={e => this.props.number("4")}>4</button>
                                <button id="5" className="button buttonNormal col-3" value="5" onClick={e => this.props.number("5")}>5</button>
                                <button id="6" className="button buttonNormal col-3" value="6" onClick={e => this.props.number("6")}>6</button>
                    ...
                    <Col xs="12" sm="12">
                        <Row>
                            <Col xs="9" sm="9" style={paddingStyle}>
                                <button id="1" className="button buttonNormal col-4" value="1" onClick={e => this.props.number("1")}>1</button>
                                <button id="2" className="button buttonNormal col-4" value="2" onClick={e => this.props.number("2")}>2</button>
                                <button id="3" className="button buttonNormal col-4" value="3" onClick={e => this.props.number("3")}>3</button>
                                ...
                                <button id="0" className="button buttonNormal col-4" value="0" onClick={e => this.props.number("0")}>0</button>
